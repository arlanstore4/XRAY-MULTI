...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━=======
# Link Hosting Kalian
prjkt="raw.githubusercontent.com/arlanstore4/cfnfree/main/ssh"
echo ""
echo ""
...
curl https://raw.githubusercontent.com/arlanstore4/cfnfree/main/ssh/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/arlanstore4/cfnfree/main/ssh/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/arlanstore4/cfnfree/main/ssh/index.html1"
/etc/init.d/nginx restart
cd
cd
sudo apt remove apache2 -y  &>/dev/null
...
cd $HOME
    ...
    echo 'echo "" ' >>.bashrc
    echo 'echo "" ' >>.bashrc
    echo 'echo -e "\t\033[92mTelegram   : @arlanstore4, @arlanstore4 " ' >>.bashrc
    echo 'echo -e "\t\e[1;33mPowered by : arlanstore4."' >>.bashrc
    echo 'echo ""' >>.bashrc
