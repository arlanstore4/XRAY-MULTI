...
echo ""
# Add Domain
wget https://raw.githubusercontent.com/arlanstore4/XRAY-MULTI/main/updated/adddomain.sh && chmod +x adddomain.sh && ./adddomain.sh
#
#install tools/alat
wget https://raw.githubusercontent.com/arlanstore4/XRAY-MULTI/main/install-tools.sh && chmod +x install-tools.sh && ./install-tools.sh
#
#Instal Xray
wget https://raw.githubusercontent.com/arlanstore4/XRAY-MULTI/main/install-xray.sh && chmod +x install-xray.sh && ./install-xray.sh
#install menu
wget https://raw.githubusercontent.com/arlanstore4/XRAY-MULTI/main/menu/updatedll.sh && chmod +x updatedll.sh && ./updatedll.sh
#
